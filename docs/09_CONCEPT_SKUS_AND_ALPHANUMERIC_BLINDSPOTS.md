...
In [`app/models.py`](file:///Users/jnarayanassamy/personal/kids/canishe_rahul/OmniQuery-AI/app/models.py#L78-L92), our `Product` table stores the `sku` column as an indexed unique string:
```sql
