...
async def seed_database():
    ...
    async with AsyncSessionLocal() as session:
        ...
        p1 = Product(
            sku="SKU-SRV-101",
            name="OmniCloud Enterprise Server 1U",
            category="Hardware",
            price=2499.00,
            stock_quantity=45,
        )
        p2 = Product(
            sku="SKU-SW-202",
            name="OmniQuery AI Analytics Pro License",
            category="Software",
            price=499.00,
            stock_quantity=500,
        )
        ...
        c1 = Customer(
            ...
            email="procurement@acmefin.com",
            country="USA",
            tier="Enterprise",
        )
        c2 = Customer(
            name="Bangalore AI Labs",
            email="admin@bangaloreai.in",
            country="India",
            tier="Gold",
        )
        c3 = Customer(
            name="Dallas Logistics LLC",
        ...
        # 4. Add Order Items
        item1 = OrderItem(
            order_id=o1.id, product_id=p1.id, quantity=2, unit_price=2499.00
        )
        item2 = OrderItem(
            order_id=o1.id, product_id=p2.id, quantity=1, unit_price=499.00
        )
        item3 = OrderItem(
            order_id=o2.id, product_id=p2.id, quantity=3, unit_price=499.00
        )
        item4 = OrderItem(
            order_id=o3.id, product_id=p4.id, quantity=1, unit_price=350.00
        )
